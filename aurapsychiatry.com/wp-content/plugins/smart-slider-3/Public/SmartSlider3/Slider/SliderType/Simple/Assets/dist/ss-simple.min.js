!(function (t) {
  ...
  var s = t.document,
    ...
    h = t.clearTimeout,
    a = i._N2,
    r = (t.requestAnimationFrame, Object.assign),
    o = function (t, i, s) {
      t.setAttribute(i, s);
    },
    c = function (t, i) {
    ...
    l = function (t, i) {
      return u(t, new Event(i, { bubbles: !1, cancelable: !1 }));
    },
    f = function (t, i, s) {
  ...
  !(function (t) {
    ...
    a.d(
      ...
      function () {
        function t(t, i) {
          switch (
            ((this.postBackgroundAnimation = !1),
            (this._currentBackgroundAnimation = !1),
            ...
            i.duration < 300 && (i.type = "no"),
            a.SmartSliderMainAnimationAbstract.prototype.constructor.call(
              this,
              t,
              i
            ),
        ...
        return (
          (t.prototype = Object.create(
            a.SmartSliderMainAnimationAbstract.prototype
          )),
          (t.prototype.constructor = t),
          (t.prototype.changeTo = function (t, i, s, n) {
            this.postBackgroundAnimation &&
              this.postBackgroundAnimation.prepareToSwitchSlide(t, i),
              a.SmartSliderMainAnimationAbstract.prototype.changeTo.apply(
                this,
                arguments
              );
          }),
          (t.prototype.setActiveSlide = function (t) {
            for (var i = 0; i < this.slider.slides.length; i++)
              this.slider.slides[i] !== t &&
                this.hideSlide(this.slider.slides[i]);
          }),
          (t.prototype.hideSlide = function (t) {
            a.MW.R(t.SMWs, { x: -1e5 * n2const.rtl.modifier }),
              o(t.background.element, "aria-hidden", "true");
          }),
          (t.prototype.showSlide = function (t) {
            a.MW.R(t.SMWs, { x: 0, y: 0 }),
              c(t.background.element, "aria-hidden");
          }),
          (t.prototype.cleanSlideIndex = function (t) {
            this.hideSlide(this.slider.slides[t]);
          }),
          (t.prototype.revertTo = function (t, i) {
            a.MW.R(this.slider.slides[i].SMWs, { zIndex: "" }),
              this.hideSlide(this.slider.slides[i]),
              a.SmartSliderMainAnimationAbstract.prototype.revertTo.apply(
                this,
                arguments
              );
          }),
          ...
          (t.prototype.onChangeToComplete = function (t, i, s) {
            null !== this.reverseSlideIndex &&
              (l(
                this.slider.slides[this.reverseSlideIndex].element,
                "mainAnimationStartInCancel"
              ),
              (this.reverseSlideIndex = null)),
              this.hideSlide(t),
              c(i.background.element, "aria-hidden"),
              a.SmartSliderMainAnimationAbstract.prototype.onChangeToComplete.apply(
                this,
                arguments
              );
          }),
          (t.prototype.onReverseChangeToComplete = function (t, i, s) {
            this.hideSlide(t),
              a.SmartSliderMainAnimationAbstract.prototype.onReverseChangeToComplete.apply(
                this,
                arguments
              );
          }),
          (t.prototype._mainAnimationNo = function (t, i) {
            (this.parameters.delay = 0),
              ...
              this._mainAnimationFade(t, i);
          }),
          (t.prototype._mainAnimationFade = function (t, i) {
            a.MW.R(t.SMWs, { zIndex: 23 }),
              this.showSlide(i),
              t.unsetActive(),
              i.setActive();
            ...
            if (0 !== this.parameters.shiftedBackgroundAnimation) {
              var n = !1,
                h = !1;
              if (
                ("auto" === this.parameters.shiftedBackgroundAnimation
                  ? t.hasLayers()
                    ? (n = !0)
                    : (h = !0)
                  : (n = !0),
                this._currentBackgroundAnimation && n)
              ) {
                var r = s.outDuration - s.extraDelay;
                r > 0 && this.timeline.shiftChildren(r),
                  this._currentBackgroundAnimation.shiftedPreSetup &&
                    this._currentBackgroundAnimation._preSetup();
              } else
                h &&
                  (s.extraDelay > 0 &&
                    this.timeline.shiftChildren(s.extraDelay),
                  this._currentBackgroundAnimation.shiftedPreSetup &&
                    this._currentBackgroundAnimation._preSetup());
            } else
              !1 !== this._currentBackgroundAnimation && (s.outDelay += 0.1);
            var o = [t.SMWs[0]];
            !this._currentBackgroundAnimation && t.SMWs[1] && o.push(t.SMWs[1]),
              this.timeline.fromTo(
                o,
                s.outDuration,
                { opacity: 1 },
                { opacity: 0, ease: this.getEase() },
                s.outDelay
              );
            ...
            this.timeline.fromTo(
              ...
              s.inDuration,
              { opacity: 0 },
              { opacity: 1, ease: this.getEase() },
              s.inDelay
            ),
              !this._currentBackgroundAnimation &&
                i.background &&
                (a.MW.k(i.background.element).opacity = 1),
              f(
                this.sliderElement,
                "mainAnimationComplete",
                function (e) {
                  var t = this.slider.slides[e.detail.previousSlideIndex];
                  a.MW.R(t.SMWs, { zIndex: "", opacity: 1 });
                }.bind(this)
              ),
          ...
          (t.prototype._mainAnimationCrossFade = function (t, i) {
            ...
            var c = [i.SMWs[0]];
            !this._currentBackgroundAnimation && i.SMWs[1] && c.push(i.SMWs[1]),
              this.timeline.fromTo(
                c,
                s.inDuration,
                { opacity: 0 },
          ...
          (t.prototype._mainAnimationVertical = function (t, i, s) {
            this.showSlide(i),
              this.__mainAnimationDirection(t, i, "vertical", s);
          }),
          ...
          (t.prototype.__mainAnimationDirection = function (t, i, s, n) {
            ...
            "horizontal" === s
              ? ((c = "x"),
                (u = Math.floor(
                  this.slider.responsive.resizeContext.slideOuterWidth
                )),
                n2const.rtl.isRtl && (n = !n))
              : "vertical" === s &&
                ((c = "y"),
                (u = Math.floor(
                  this.slider.responsive.resizeContext.slideOuterHeight
                ))),
              n && (u *= -1);
            var l = {},
              d = { snap: "x,y", ease: this.getEase() },
              v = { snap: "x,y", ease: this.getEase() };
            (l[c] = u), (v[c] = -u), a.MW.R(h, { zIndex: 23 });
            var m = { zIndex: 23 };
            (m[c] = u), a.MW.R(r, m), t.unsetActive(), i.setActive();
            var p,
              S = this.adjustMainAnimation();
            if (
              ((d[c] = 0),
              this.timeline.fromTo(r, S.inDuration, l, d, S.inDelay),
              ...
              if (
                ("auto" === this.parameters.shiftedBackgroundAnimation
                  ? t.hasLayers()
                    ...
                    : (x = !0)
                  : (y = !0),
                this._currentBackgroundAnimation && y)
              ) {
                var b = S.outDuration - S.extraDelay;
                b > 0 && this.timeline.shiftChildren(b),
                  this._currentBackgroundAnimation.shiftedPreSetup &&
                    this._currentBackgroundAnimation._preSetup();
              } else
                x &&
              ...
              !1 !== this._currentBackgroundAnimation && (S.outDelay += 0.1);
            if (
              (this.timeline.to(h, S.outDuration, v, S.outDelay),
              this.isTouch && this.isReverseAllowed)
            )
              if (
                (n
                  ? (this.slider.blockCarousel &&
                ...
                (this.reverseSlideIndex = p.index),
                  this.enableReverseMode(),
                  o.push(p),
                  "vertical" === s && this.showSlide(p);
                var D = p.SMWs,
                  z = {};
                (z[c] = u), a.MW.R(D, z);
                var A = {},
                  I = { snap: "x,y", ease: this.getEase() },
                  w = {},
                  C = { snap: "x,y", ease: this.getEase() };
                (I[c] = 0),
                  (A[c] = -u),
                  (C[c] = u),
                  (w[c] = 0),
                  p.K("mainAnimationStartIn", {
                    mainAnimation: this,
                    previousSlideIndex: t.index,
                    currentSlideIndex: p.index,
                    isSystem: !1,
                  }),
                  this.reverseTimeline.paused(!0),
                  this.reverseTimeline.eventCallback(
                    "onComplete",
                    this.onBackwardChangeToComplete.bind(this),
                    [t, p, !1]
                  ),
                  this.reverseTimeline.fromTo(D, S.inDuration, A, I, S.inDelay),
                  this.reverseTimeline.fromTo(h, S.inDuration, w, C, S.inDelay);
            ...
            f(
              ...
              function (e) {
                var t = this.slider.slides[e.detail.previousSlideIndex],
                  i = this.slider.slides[e.detail.currentSlideIndex];
                a.MW.R(t.SMWs, { zIndex: "" }), a.MW.R(i.SMWs, { zIndex: "" });
              }.bind(this)
            ),
              this.slider.updateInsideSlides(o);
          }),
    ...
    a.d("SmartSliderResponsiveSimple", ["SmartSliderResponsive"], function () {
      function t() {
        (this.round = 1),
          a.SmartSliderResponsive.prototype.constructor.apply(this, arguments),
          (this.xt = this.sliderElement.classList.contains(
            "n2-ss-full-page--constrain-ratio"
          )),
          (this.mainAnimation = this.slider.mainAnimation);
      }
      return (
        (t.prototype = Object.create(a.SmartSliderResponsive.prototype)),
        (t.prototype.constructor = t),
        (t.prototype.init = function () {
          a.SmartSliderResponsive.prototype.init.call(this),
            (this._cacheEl = {
              slider:
              ...
              "n2-ss-slider-2":
                this.sliderElement.querySelector(".n2-ss-slider-2"),
              "n2-ss-slider-3":
                this.sliderElement.querySelector(".n2-ss-slider-3"),
            }),
            this._cacheEl["n2-ss-slider-3"].addEventListener(
              "scroll",
              function (e) {
        ...
        (t.prototype.calculateResponsiveValues = function () {
          ...
          if (
            ((this.resizeContext.slideOuterWidth = h.width),
            (this.resizeContext.slideOuterHeight = h.height),
            a.SmartSliderResponsive.prototype.calculateResponsiveValues.call(
              this
            ),
            this.xt)
          ) {
            var r =
              ...
              o =
                (this.resizeContext.sliderHeight -
                  ...
                  -2 +
                "px";
            a.MW.k(this._cacheEl.slider)["--ss-clip-path"] =
              "inset(" + o + " " + r + " " + o + " " + r + ")";
          }
        }),
        (t.prototype.onStarterSlide = function (t) {
          this.slider.slides.forEach(function (t) {
            (t.SMWs = [a.MW.k(t.element, { x: "-10000px" })]),
              t.background &&
                t.SMWs.push(a.MW.k(t.background.element, { x: "-10000px" }));
          }),
            a.SmartSliderResponsive.prototype.onStarterSlide.apply(
              this,
              arguments
            ),
    ...
    a.d("SmartSliderSimple", ["SmartSliderAbstract"], function () {
      function t(t, i) {
        (this.type = "simple"),
          a.SmartSliderAbstract.prototype.constructor.call(
            this,
            t,
            r({ bgAnimations: 0, carousel: 1 }, i)
          );
      }
      return (
        (t.prototype = Object.create(a.SmartSliderAbstract.prototype)),
        (t.prototype.constructor = t),
        (t.prototype.initResponsiveMode = function () {
          (this.responsive = new a.SmartSliderResponsiveSimple(
            this,
            this.parameters.responsive
          )),
            this.responsive.start(),
            a.SmartSliderAbstract.prototype.initResponsiveMode.call(this);
        }),
        (t.prototype.initMainAnimation = function () {
          !this.disabled.backgroundAnimations && this.parameters.bgAnimations
            ? (this.mainAnimation =
                new a.SmartSliderFrontendBackgroundAnimation(
                  this,
                  this.parameters.mainanimation,
                  this.parameters.bgAnimations
                ))
            : (this.mainAnimation = new a.SmartSliderMainAnimationSimple(
                this,
                this.parameters.mainanimation
              ));
        }),
        (t.prototype.afterRawSlidesReady = function () {
          ...
          if (
            this.parameters.bgAnimations &&
            this.parameters.bgAnimations.slides
          ) {
            for (var i = 0; i < this.slides.length; i++)
              this.slides[i].backgroundAnimation =
                this.parameters.bgAnimations.slides[i];
